    ...
    internal class SpeedTreeMaterialInspector : ShaderGUI
    {
      ...
      "GEOM_TYPE_MESH"
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            SpeedTreeMaterialInspector.SpeedTreeGeometryType geomType = (SpeedTreeMaterialInspector.SpeedTreeGeometryType)EditorGUILayout.EnumPopup("Geometry Type", (System.Enum)treeGeometryTypeArray[0]);
            ...
            {
                if ((uint)(prop6.propertyFlags & UnityEngine.Rendering.ShaderPropertyFlags.HideInInspector) <= 0U)
