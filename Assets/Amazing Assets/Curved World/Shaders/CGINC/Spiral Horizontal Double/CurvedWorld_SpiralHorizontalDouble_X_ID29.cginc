...
uniform float3 CurvedWorld_SpiralHorizontalDouble_X_ID29_PivotPoint;
uniform float3 CurvedWorld_SpiralHorizontalDouble_X_ID29_RotationCenter;
...
void CurvedWorld_SpiralHorizontalDouble_X_ID29(inout float3 vertexOS)
{
    ...
    CurvedWorld_SpiralHorizontalDouble_X_ID29(vertex);
