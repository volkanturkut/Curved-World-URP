...
uniform float3 CurvedWorld_SpiralVertical_X_Negative_ID14_PivotPoint;
uniform float3 CurvedWorld_SpiralVertical_X_Negative_ID14_RotationCenter;
...
void CurvedWorld_SpiralVertical_X_Negative_ID14(inout float3 vertexOS)
{
    ...
    CurvedWorld_SpiralVertical_X_Negative_ID14(vertex);
