...
uniform float3 CurvedWorld_SpiralVerticalDouble_X_ID24_PivotPoint;
uniform float3 CurvedWorld_SpiralVerticalDouble_X_ID24_RotationCenter;
uniform float3 CurvedWorld_SpiralVerticalDouble_X_ID24_RotationCenter2;
...
void CurvedWorld_SpiralVerticalDouble_X_ID24(inout float3 vertexOS)
{
    ...
    CurvedWorld_SpiralVerticalDouble_X_ID24(vertex);
